...
►runtime
►Check:
By : INSAN & TRIANAS AND TEAM INSANITY
"""
...
#--------------------------------------------------------
		...
		try:
		    ...
		    cl.comment(url['result']['posts'][0]['userInfo']['mid'], url['result']['posts'][0]['postInfo']['postId'], "Like bye Team Insanity")
		    ki.comment(url['result']['posts'][0]['userInfo']['mid'], url['result']['posts'][0]['postInfo']['postId'], "Like bye insanity")
		    kk.comment(url['result']['posts'][0]['userInfo']['mid'], url['result']['posts'][0]['postInfo']['postId'], "Mau Bot Protect?\nFollow ig : @insan.m.s014\nLalu dm ke dia")
...
#--------------------------------------------------------
	        ...
	        cl.sendText(msg.to,"INSANITY01")
                ki.sendText(msg.to,"INSANITY02  \(ˆ▿ˆ)/")
                kk.sendText(msg.to,"INSANITY03  \(ˆ▿ˆ)/")
                kc.sendText(msg.to,"INSANITY05 Hadiir  \(ˆ▿ˆ)/")
